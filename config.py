...
# smolagents 的 LiteLLMModel 通过 litellm 的 OpenAI 兼容模式接入智谱
LITELLM_MODEL_ID = f"openai/{LLM_MODEL}"
...
# ---------- 鉴权 ----------
# API_KEY：单值字符串；空 = 开发模式（免鉴权）；非空 = 强制校验 X-API-Key 头
API_KEY = os.getenv("API_KEY", "")

# ---------- 安全兜底 ----------
# RAG 置信度门槛：低于此值判定为「低置信度」，返回不确定；0 = 关闭拒答
